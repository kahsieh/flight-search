...
class ItineraryTable {
  ...
  static loadFromURL() {
    ...
    if ("n" in urlParams && "i" in urlParams) {
      ...
      ItineraryTable.loadFromItinerary(new Itinerary(urlParams["i"]));
      return true;
    }
    return false;
  }
   ...
   */
  static loadFromItinerary(itinerary) {
    for (let i = 0; i < itinerary.length; i++) {
      ItineraryTable.addFlight(itinerary, i);
    }
  }
   ...
   */
  static addFlight(itinerary = new Itinerary(), i = 0) {
    ...
    row.innerHTML = `
      ...
      <td class="select_airlines"><div class="row"><div class="input-field col s12">
        <div class="right-align" style="position: absolute; right: 15px"><p><label>
          <input type="checkbox" name="select_airlines_exclude" class="filled-in" ${itinerary.get(i, "select_airlines_exclude") === true ? "checked" : ""}>
      ...
      <td class="adult_hold_bag"><div class="row"><div class="col s12 input-field">
        <select name="adult_hold_bag">
          ${this.generateSelectOptions(["0", "1", "2"], itinerary.get(i, "adult_hold_bag"), "adult_hold_bag")}
        </select>
        <label>Checked&nbsp;bags</label>
      </div></div></td>
      <td class="adult_hold_bag"><div class="row"><div class="col s12 input-field">
        <select name="adult_hand_bag">
          ${this.generateSelectOptions(["0", "1"], itinerary.get(i, "adult_hand_bag"), "adult_hand_bag")}
        </select>
      ...
      <td class="select_stop_airport"><div class="row"><div class="input-field col s12">
        <div class="right-align" style="position: absolute; right: 15px"><p><label>
          <input type="checkbox" name="select_stop_airport_exclude" class="filled-in" ${itinerary.get(i, "select_stop_airport_exclude") === true ? "checked" : ""}>
          <span style="padding-left: 25px">Not</span>
        </label></p></div>
      ...
      <td class="conn_on_diff_airport"><div class="row"><div class="input-field col s12">
        <p><label>
          <input type="checkbox" name="conn_on_diff_airport" class="filled-in" ${itinerary.get(i, "conn_on_diff_airport") === true ? "checked" : ""}>
   ...
   */
  static selectFilters(itinerary) {
    ...
    for (const k of itinerary.nonDefaultFields()) {
